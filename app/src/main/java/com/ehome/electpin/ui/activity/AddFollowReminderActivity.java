 ...
 * 添加提醒
 */
public class AddFollowReminderActivity extends BaseActivity {

    public static void startAddFollowReminderActivity(Context context) {
        Intent intent = new Intent(context, AddFollowReminderActivity.class);
        context.startActivity(intent);
    }

    @Override
    public int onBindLayout() {
        return R.layout.activity_add_follow_reminder;
    }
    ...
    public void initView() {
        ...
        headerSetting(this, "添加提醒", false, true);
    }
